...
export Theorems (fermat_solution_iff_motor fermat_pos_lt mismatchRotor_eq_rotorTorsion
  ...
  commutator_fermatTorsion_null1 commutator_fermatTorsion_null1_ne_cyclic
  exists_sandwich_fermat_ne_cyclic_null1
  commutator_fermatTorsion_null3_two
  commutator_fermatTorsion_null3_two_ne_cyclic
  ...
  exists_primitive_odd_pos_cube_of_pos
  BealPosCubeAddTwoCubeResidual_iff_no_primitive_odd
  gcd_cube_diff_eq_one_or_three
  pos_cube_three_descent_dichotomy
  exists_pos_cube_gcd_one_half_sum exists_pos_cube_gcd_three_half_sum
  pos_cube_eq_of_gcd_one_params pos_cube_eq_of_gcd_three_params
  padicValNat_three_of_pos_cube_three_dvd
  BealEqualOddTwoFactorResidual_of_pos_cube_and_ge_five
  nat_cube_mod_seven nat_cube_mod_nine nat_cube_mod_thirteen nat_cube_mod_nineteen
  pos_cube_add_two_cube_mod_seven_classes pos_cube_add_two_cube_mod_nine_classes
  pos_cube_add_two_cube_mod_thirteen_classes pos_cube_add_two_cube_mod_nineteen_classes
  ...
  beal_no_open_residual_perfect_power_of_le_eighty_six
  beal_no_open_residual_perfect_power_of_le_sixty_seven
