...
export Theorems (fermat_solution_iff_motor fermat_pos_lt mismatchRotor_eq_rotorTorsion
  ...
  beal_kFold_powerLattice_dvd beal_natAbs_eq_one_of_kFold_powerLattice
  beal_kFold_powerLattice_of_natAbs_eq_one beal_kFold_powerLattice_iff_natAbs_eq_one
  beal_balanced_gap_no_modularWitness
  ...
  mihailescu not_nat_pow_sub_one_of_exponents_ge_three
  not_unitAbs_pow_add_pow_eq_pow_pos
