...
\]
is extra structure. The written particle action, given a dual-channel acceleration $u$, makes the mismatch a double integrator $\ddot\delta=-u$ and supplies no restoring frequency. Holding $\ddot\phi=0$ forces $m(\phi-\theta)=0$: without a constraint on the usual rotor, both sectors move.
...
In summary, dual-only kinematics already delimit when $J$ can be shielded or reversed, and at what unsigned-mass cost. Whether nature supplies a laboratory dual force---and whether gravity is therefore a controllable torsional degree of freedom---is the experimental question of the coming decade.
