...
\(\texttt{Geometric}\), and \(\texttt{Potential}\). Under
\(\texttt{DstDiophantine.Logic.Quantum}\) the dual-layer modules are
\(\texttt{Separation}\), \(\texttt{DualSector}\), \(\texttt{Quaternion}\),
\(\texttt{Spinor}\), \(\texttt{QuantumLogic}\), and \(\texttt{Dictionary}\).
